...
The colour and map sections use `RColorBrewer`, `maps` and `mapproj`;
install them once with `install.packages()`.
...
Everything in that loop is `png()` and `dev.off()`, plus a counter. Any figure you can draw once you can animate.
