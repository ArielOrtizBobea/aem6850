...
**Before running anything, write down what the data should show if it is
right.** On paper, or in a comment at the top of your script. The story
above implies three things; turn each into a number or a date.

1. If the story is right, which date should show the biggest gust? Write
   the date down.
2. A typical winter day downtown gusts near 20 km/h. How tall should the
   spike be? Write a number.
3. "Drought" is a claim about rain. Write down December's total rainfall
   in millimetres, as the story implies it.
...
> **Write down what the data should show. Run. Reconcile.**

::: {.content-hidden when-format="revealjs"}

Write your expectation down before you run the code. An expectation in
your head bends to match whatever appears on screen; you will remember
expecting exactly that. A written one stays put.

When the prediction and the output disagree, one of three things happened:

- **Your expectation was wrong**: you learned about the world.
...
All three teach you something. Write nothing down and the output has
nothing to disagree with; you will just believe it.

:::

::: {.content-visible when-format="revealjs"}

Expectation ≠ output means one of three things, all useful:

- your expectation was wrong → you learned about the world
- the code is wrong → you learned about your code
- the data is not what you thought → you learned about the data

Nothing written down → nothing to check.
