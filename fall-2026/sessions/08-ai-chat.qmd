...
:::: {.columns}
::: {.column width="60%"}
![](figures/08-ai-chat/S06-desktop-app-cowork.png){width="100%" fig-alt="The Claude desktop app's message box on a paid account: the Chat and Cowork toggle with Cowork selected, the model picker, and the Project or folder control under the box."}
:::
::: {.column width="40%"}
...
![The Claude desktop app with Cowork available: the Chat / Cowork toggle in the message box, and Project or folder under it. On the free plan Cowork is absent.](figures/08-ai-chat/S06-desktop-app-cowork.png){fig-align="center" fig-alt="The Claude desktop app's message box on a paid account: the Chat and Cowork toggle with Cowork selected, the model picker, and the Project or folder control under the box."}
...
:::: {.columns}
::: {.column width="60%"}
![](figures/08-ai-chat/S07-cowork-folder-connected.png){width="100%" fig-alt="Cowork in the Claude desktop app with the gapminder-practice folder connected: the empty task box with the Chat and Cowork toggle, and under it the folder name gapminder-practice next to the approval setting, which reads Auto."}
:::
::: {.column width="40%"}
1. **The folder**, named under the box
2. **The task box**: where the prompt goes
3. **Approvals**, next to the folder: switch it from Auto to the setting that asks
...
the approval setting. The capture shows Auto, which is the setting to
change. The stop control only exists while a task runs.
:::
...
![Cowork with the practice folder connected. Before typing: the folder's name under the box, the empty task box, and the approval setting next to the name, shown here on Auto.](figures/08-ai-chat/S07-cowork-folder-connected.png){fig-align="center" fig-alt="Cowork in the Claude desktop app with the gapminder-practice folder connected: the empty task box with the Chat and Cowork toggle, and under it the folder name gapminder-practice next to the approval setting, which reads Auto."}
...
to the name is the one that asks before acting (Manual), not Auto. A
Stop control appears in the task box once a run starts; know where it
